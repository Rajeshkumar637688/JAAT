...
TOKEN = '7999772359:AAGf-eZap3BGlbb5fS8y7CDmWvC2ovbVdY8'
MONGO_URI = 'mongodb+srv://Soul:JYAuvlizhw7wqLOb@soul.tsga4.mongodb.net'
FORWARD_CHANNEL_ID = -1002401271529
CHANNEL_ID = -1002401271529
error_channel_id = -1002401271529
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: http*", parse_mode='Markdown')
